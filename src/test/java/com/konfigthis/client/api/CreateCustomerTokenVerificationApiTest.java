...
public class CreateCustomerTokenVerificationApiTest {
    ...
    private static CreateCustomerTokenVerificationApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new CreateCustomerTokenVerificationApi(apiClient);
    }
    ...
    public void viaApiTest() throws ApiException {
        ...
        CreateCustomerTokenVerificationViaApiRequestData data = null;
        CreateCustomerTokenVerificationViaApiResponse response = api.viaApi(customerId)
                .data(data)
                .execute();
