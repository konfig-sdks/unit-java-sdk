...
public class DisableRecurringPaymentApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public DisableRecurringPaymentApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public DisableRecurringPaymentApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
